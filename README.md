...
**ML & Analytics:** Prophet · XGBoost · scikit-learn · Pandas · NumPy
...
- Deployed **TSA Wait Times dashboard** — live airport checkpoint data with Cloudflare edge delivery
- Expanding **airline waiver classification** to cover dynamic airport growth and new carrier patterns
- Rebuilding **OTP Dash** with improved airline KPI layout and route-level readability
- Deploying **ET modeling pipeline** with Open-Meteo + NASA POWER integration
- **Actively exploring new roles** in data engineering, automation, or geospatial systems
...
*Last updated:* <!--LAST_UPDATED-->September 23, 2026 • 01:55 PM CDT<!--/LAST_UPDATED-->
